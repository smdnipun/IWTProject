...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2020 at 12:53 PM
...
(5, 'Sunil Samarakoon', '697598464v', 'deliveryp@buyme.com', 910123456, 'Password#person', 'kj-6798', 'kandy');
...
(4, 6, 'Pen drive 32GB', 'Kingston Pen drive 32GB', 100, 1000, NULL, 'Electronics'),
(5, 6, 'Wireless Mouse', 'Wireless Mouse', 20, 1500, NULL, 'Electronics'),
(6, 6, 'Micro SD card 64GB', 'Micro SD card 64GB', 50, 4000, NULL, 'Electronics');
...
INSERT INTO `orderitem` (`Item_number`, `OID`, `Quantity`) VALUES
(4, 4, '20'),
(5, 5, '10');
...
(7, 'Geethmaka Dissanayake', '200102201108', 'admin@buyme.com', 710891055, 'Password#admin', 'admin'),
...
ALTER TABLE `orderitem`
  ADD PRIMARY KEY (`Item_number`,`OID`);
...
--
ALTER TABLE `deliveryperson`
  MODIFY `DP_ID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `item`
  MODIFY `Item_number` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
